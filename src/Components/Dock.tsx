...
export default function Dock() {
  ...
  return (
    <div className='dock dock-sm dock-active pl-0 pt-1 sticky bottom-0 z-50 mx-auto mt-auto w-full border border-b-0 glass rounded-t overflow-hidden pr-0 shadow-[inset_0px_3px_5px_0px_oklch(100%_0_0/var(--glass-border-opacity,20%)),0_0_0_2px_oklch(0%_0_0/5%)]'>

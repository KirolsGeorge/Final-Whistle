        ...
        <div className='tabs tabs-border'>
          ...
          <div className='tab-content bg-base-100 pt-2'>
            <fieldset className='fieldset bg-base-200 border-base-300 rounded-xl border p-4'>
              ...
              <input type='email' className='input rounded-xl w-full' placeholder='Email' />

              <label className='label'>Password</label>
              <input type='password' className='input rounded-xl w-full' placeholder='Password' />

              <button className='btn btn-neutral mb-1 rounded-xl'>Login</button>
              <div className='divider'>OR continue with</div>
              <div className='flex gap-2'>
                {/* GitHub */}
                <button className='flex-1 btn bg-black text-white border-black rounded-xl'>
                ...
                {/* Google */}
                <button className='flex-1 btn bg-white text-black border-[#e5e5e5]  rounded-xl'>

    ...
    <form onSubmit={handelLogin}>
      <fieldset className='fieldset bg-base-200 border-base-300 rounded-xl border p-4'>
        ...
        <div className='flex gap-2'>
          {/* GitHub */}
          <button type='button' className='flex-1 btn bg-black text-white border-black rounded-xl' onClick={() => signInWithProvider(GithubProvider)}>
          ...
          {/* Google */}
          <button type='button' className='flex-1 btn bg-white text-black border-[#e5e5e5] rounded-xl' onClick={() => signInWithProvider(googleProvider)}>
